...
const IMAGES = [
  ...
  { id: 6, src: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1600", title: "Quiet Confidence", category: "Portrait", location: "Studio" },
  ...
  { id: 10, src: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?q=80&w=1600", title: "Portrait in Blue", category: "Portrait", location: "Outdoor" },
...
const CATEGORIES = ["All", "Wildlife", "Nature", "Landscape", "Portrait"];
    ...
    <div className="min-h-screen bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100">
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <motion.p initial={{y:20, opacity:0}} whileInView={{y:0, opacity:1}} viewport={{once:true}} transition={{delay:0.08}} className="mt-4 text-lg text-neutral-600 dark:text-neutral-300">
                Wildlife • Nature • Landscape • Portrait
              </motion.p>
      ...
      <section id="gallery" className="mx-auto max-w-7xl px-4 md:px-6 py-10">
        ...
        <motion.div layout className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          <AnimatePresence>
            {filtered.map((img) => (
              <motion.figure key={img.id} layout initial={{opacity:0, y:10}} animate={{opacity:1, y:0}} exit={{opacity:0}} className="group rounded-2xl overflow-hidden border border-neutral-200 dark:border-neutral-800 bg-neutral-50/40 dark:bg-neutral-900/40">
                <button onClick={() => openLightbox(img.id)} className="relative block w-full focus:outline-none">
                  <img src={img.src} alt={img.title} className="h-64 w-full object-cover transition-transform duration-300 group-hover:scale-[1.03]"/>
